...
class MockDataService {
  ...
  static final List<HackathonModel> _mockHackathons = [
    HackathonModel(
      ...
      description:
          'Build innovative AI solutions that solve real-world problems. Join developers, designers, and entrepreneurs for 48 hours of intensive coding.',
      type: 'Online',
    ...
    HackathonModel(
      ...
      description:
          'Create the next generation of decentralized finance applications. Build on Ethereum, Polygon, or Solana.',
      type: 'Hybrid',
      themeOrFocus: 'Blockchain, DeFi, Smart Contracts',
      startDate: DateTime.now().add(const Duration(days: 15)),
      endDate: DateTime.now().add(const Duration(days: 18)),
      prizePoolDetails:
          '1st Place: \$15,000, 2nd Place: \$8,000, Best Innovation: \$3,000',
    ...
    HackathonModel(
      ...
      description:
          'Design and develop mobile applications that enhance user productivity and daily life.',
      type: 'Offline',
      themeOrFocus: 'Mobile Development, UX/UI Design',
      startDate: DateTime.now().subtract(const Duration(days: 2)),
      endDate: DateTime.now().add(const Duration(days: 1)),
      prizePoolDetails:
          '1st Place: \$8,000, 2nd Place: \$4,000, People\'s Choice: \$2,000',
    ...
    HackathonModel(
      ...
      description:
          'Develop technology solutions for environmental sustainability and climate change.',
      type: 'Online',
      ...
      prizePoolDetails:
          '1st Place: \$12,000, 2nd Place: \$6,000, Impact Award: \$4,000',
    ...
    HackathonModel(
      ...
      description:
          'Create the next generation of gaming experiences using cutting-edge technology.',
      type: 'Online',
      ...
      prizePoolDetails:
          '1st Place: \$18,000, 2nd Place: \$9,000, Creative Award: \$3,000',
  ...
  HackathonModel updateHackathon(HackathonModel hackathon) {
    ...
    if (index != -1) {
      final updatedHackathon = hackathon.copyWith(updatedAt: DateTime.now());
  ...
  Map<String, dynamic> getAnalytics() {
    ...
    final upcomingHackathons = _mockHackathons
  ...
  List<HackathonModel> searchHackathons(String query) {
    ...
    return _mockHackathons.where((hackathon) {
      return hackathon.name.toLowerCase().contains(lowercaseQuery) ||
          ...
          (hackathon.themeOrFocus?.toLowerCase().contains(lowercaseQuery) ??
              false);
    }).toList();
  }
